      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold">Online Course Platform</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/courses?category=development" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Development
                </Link>
              </li>
              <li>
                <Link href="/courses?category=business" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Business
                </Link>
              </li>
              <li>
                <Link href="/courses?category=design" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Design
                </Link>
              </li>
              <li>
                <Link href="/courses?category=marketing" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Marketing
                </Link>
              </li>
              <li>
                <Link href="/courses?category=health" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Health & Fitness
                </Link>
              </li>
              <li>
                <Link href="/courses?category=music" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Music
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Online Course Platform. All rights reserved.
            </p>
